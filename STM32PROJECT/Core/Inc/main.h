...
/* Private defines -----------------------------------------------------------*/
#define LED_RED_VER_Pin GPIO_PIN_5
#define LED_RED_VER_GPIO_Port GPIOA
#define LED_YELLOW_VER_Pin GPIO_PIN_6
#define LED_YELLOW_VER_GPIO_Port GPIOA
#define LED_GREEN_VER_Pin GPIO_PIN_7
...
#define LED_RED_HOR_Pin GPIO_PIN_8
#define LED_RED_HOR_GPIO_Port GPIOA
#define LED_YELLOW_HOR_Pin GPIO_PIN_9
#define LED_YELLOW_HOR_GPIO_Port GPIOA
#define LED_GREEN_HOR_Pin GPIO_PIN_10
